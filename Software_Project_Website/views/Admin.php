  ...
  <div class="panel panel-default">
      <div class="panel-heading">Customer Users</div>
        <div class="panel-body">
          ...
          $sql = "SELECT customerID, nameC, emailC, LoggedIn
                  FROM customer
                  Group by customerID;";
               ...
               echo '<tr><th>CustomerID</th><th>Name</th><th>Email</th><th>LoggedIn</th></tr>';
...
?>
            <!-- Creating 'Edit' and 'Delete' button at each row -->
             <td>
               <button class="btn btn-primary" type="button" data-toggle="modal" id="Edit" href="#cEdit-Modal<?php echo $id ?>">Edit</button>
               <button class="btn btn-danger" type="button"  data-toggle="modal" id="Delete"  href="#delete<?php echo $id; ?>">Delete</button>
           </td>


             <!--CUSTOMER EDIT MODAL-->
             <div id="cEdit-Modal<?php echo $id ?>" class="modal fade">
